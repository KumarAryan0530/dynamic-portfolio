            ...
            <div className="transform ease-linear duration-300 container flex flex-wrap justify-between items-center mx-auto">
                <Link href="/">
                    <a href="#" className=" flex gap-1 items-center">
                        <Image height={35} width={35} src="/logo.png" className="group-hover:rotate-90 transition ease-in-out duration-1000 mr-1 h-6 sm:h-10" alt="Kumar Aryanlogo Logo" />
                        <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white sm:tracking-widest ">Kumar Aryan</span>
                    </a>
                </Link>
